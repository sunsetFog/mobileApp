<template>
    <section id="searchProducts">
        <div class="search-box">
            <div class="magic">
                <img @click="backWay" class="u333" src="@sky/static/mall/register/u333.png"/>
            </div>
        ...
        <div class="atmosphere">
            ...
            <div class="shai-xuan">
                <div>
                    <img v-if="layout_active == 'yi'" src="@sky/static/mall/search/yi.png" @click="layoutWay('er')"/>
                    <img v-if="layout_active == 'er'" src="@sky/static/mall/search/er.png" @click="layoutWay('yi')"/>
                </div>
                <div @click="screenWay">
                    <span>筛选</span>
