<template>
    <section id="registerUnit">
        ...
        <div class="cartoon-apt">
            <img class="u2808" src="@sky/static/mall/login/u2808.png"/>
        </div>
        <div class="mars-apt">
            <img class="u2839" src="@sky/static/mall/login/u2839.png"/>
            <input class="jupiter-apt" type="text" v-model="withForm.username" placeholder="输入手机号码"/>
        </div>
        <div class="saturn-apt">
            <img class="u2882" src="@sky/static/mall/register/u2882.png"/>
            <input class="venus-apt" type="text" v-model="withForm.password" placeholder="输入短信验证码"/>
            <span class="yanzhengma">发送验证码</span>
        </div>
        <div class="saturn-apt">
            <img class="u2882" src="@sky/static/mall/login/u2843.png"/>
        ...
        <div class="undercurrent-apt">
            <img @click="readWay(true)" v-if="!read_active" src="@sky/static/mall/register/u2600.png"/>
            <img @click="readWay(false)" v-else src="@sky/static/mall/register/u2601.png"/>
