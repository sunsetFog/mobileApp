<template>
    <section id="followDetails">
        <headDesign title="Victoria's Secret">
            <img class="summer" src="@sky/static/mall/follow/u1033.png"/>
        </headDesign>
        <div class="mercury">
            <img src="@sky/static/mall/homePage/u40.png"/>
            <button>制造商直供</button>
        </div>
        <div class="cartoon" style="margin: 0;">
            <div class="shang-pin">
                <img class="u88" src="@sky/static/mall/homePage/u88.png"/>
            </div>
            <span class="box1">Victoria's Secret</span>
            <span class="box2">国际著名内衣品牌</span>
            <span class="box3">美国</span>
            <span class="box4">1000</span>
            <img class="u2279" src="@sky/static/mall/follow/u2279.png"/>
            <img class="u193" src="@sky/static/mall/follow/u193.png"/>
            <button @click="rainWay()">
                <img v-if="!rainbow.active" src="@sky/static/mall/follow/u2283.png"/>
                <img v-if="rainbow.active" src="@sky/static/mall/follow/u2284.png"/>
        ...
        <div class="saturn">
            <img v-if="!fabulous" @click="honey" src="@sky/static/mall/follow/u2288.png"/>
            <img v-else @click="honey" src="@sky/static/mall/follow/u2306.png"/>
        </div>
...
<script>
import fresh from '@/views/essentialsUnit/homePage/fresh.vue';
export default {
    name: "followDetails",
    components: { fresh },
    data() {
